	...
	<body>
		...
		<div id="wrapper">
			...
			<nav id="nav">
				...
				<a href="#work" class="icon fa-list-alt"><span>Clientes</span></a>
				<a href="#contact" class="icon fa-plus-circle"><span>Adicionar</span></a>	
			</nav>
						...
						<div class="row">
							<div class="4u 12u$(mobile)">
                            	...
                            	<%for(Teste t: servico.findProficinal(p.getProfId())){ %>
                            		...
                            		<div>
										<form action="TelaDeCliente.action" method="post" name="subCli<%=c.getId()%>">
											<input type="hidden" name="id" value=<%=c.getId()%>>
											<input type="hidden" name="prof" value=<%=p.getNome()%>>
										</form>										
									</div>
	                            	...
	                            	<form action="RemoverCrianca.action" method="post">
	                                	...
	                                	<input type="submit" value="Deletar <%=c.getNome()%>" class="submitButton">  
	                                </form>
                               	<%}%>
							</div>
						</div>
