	...
	<div
		...
		<div>
			<form action="ResultadosTeste.action" method="post" align="center">
				...
				<input type="submit" value="Resultados de <%=c.getNome()%>"
					class="submitButton">
			</form>
		</div>
		<br />
				...
				<div align="center">
					...
					<div class="6u$ 12u$(mobile) cell">
						...
						<input type="date" name="nasc" placeholder="Nascimento"
							value="<%=sdf.format(c.getCriancaNasc().getTime())%>" />
					</div>
					<br />
					<div class="6u$ 12u$(mobile) cell">
						<input type="radio" name="sexo" value="m"
							<%if(c.getCriancaSexo().equals("m")){%> checked <%}%>>Masculino
						<input type="radio" name="sexo" value="f"
							<%if(c.getCriancaSexo().equals("f")){%> checked <%}%>>Feminino
					</div>
					<br />
					<div class="6u$ 12u$(mobile) cell">
